...
DROP TABLE IF EXISTS test_quizzes;
DROP TABLE IF EXISTS test_questions;
DROP TABLE IF EXISTS test_answers;
DROP TABLE IF EXISTS test_options;
DROP TABLE IF EXISTS test_quiz_history;
...
CREATE TABLE test_quiz_history(
                             quiz_id INT,
                             quiz_name VARCHAR(100),
                             picture_url VARCHAR(1024) DEFAULT 'https://d1ymz67w5raq8g.cloudfront.net/Pictures/480xany/6/5/5/509655_shutterstock_1506580442_769367.jpg',
                             username VARCHAR(35),
...
INSERT INTO test_quizzes(quiz_name, description, picture_url, creator_username, created_time, category, views, taken)
VALUES
    ('Mixed Quiz', 'This quiz contains a question of each type', 'https://viralsolutions.net/wp-content/uploads/2019/06/shutterstock_749036344.jpg', 'almasxit', '2024-07-28 01:48:46', 5, 6, 4);
...
INSERT INTO test_questions (question_text, question_type, picture_url, sorted_relevant, quiz_id, score)
VALUES
...
INSERT INTO test_options (question_id, answer)
VALUES
    (2, 'Homecoming'),
    (2, 'Ni**as in Paris'),
...
INSERT INTO test_answers (question_id, answer, answer_num)
VALUES
    (1, 'Gabagool', -1),
    (1, 'Capocol', -1),
...
INSERT INTO test_questions(question_text, question_type, picture_url, sorted_relevant, quiz_id)
VALUES
...
INSERT INTO test_quizzes(quiz_name, description, creator_username, created_time, multi_page, category, views, taken)
VALUES
    ('Barcelona', 'How well do you know the history of FC Barcelona?', 'Bacha', '2024-07-25 01:48:46', 0, 10, 17, 4);
...
VALUES
    ...
    ('Choose from the list all the Brazilian players who played for Barca', 5, NULL, 0, 2),
...
INSERT INTO test_quizzes(quiz_name, description, picture_url, creator_username, created_time, multi_page, category, views, taken)
VALUES
    ('Geography!', 'This quiz contains different question about geography, including flags, countries, states, capitals and so on', 'https://study.com/cimages/videopreview/p3c2j8y73a.jpg', 'almasxit', '2024-07-23 10:48:46', 1, 1, 15, 4),
    ('Asoiaf', 'Quiz about George RR Martin\'s \"A Song of Ice and Fire\"', 'https://awoiaf.westeros.org/images/thumb/f/fc/Cristi_Balanescu_wolves_of_the_north_cover.jpg/900px-Cristi_Balanescu_wolves_of_the_north_cover.jpg', 'almasxit', '2024-06-29 22:48:46', 1, '4', 20, 4),
    ('Tarantino', 'Quentined and Tarantined by Writtin Directino', 'https://media.tenor.com/3160R1pQhaEAAAAM/tarantino-sunglasses.gif', 'almasxit', '2024-06-29 14:48:46', 0, '6', 12, 5),
     ('Chemistry','Quiz about basic chemistry','https://i.pinimg.com/564x/cc/3d/fb/cc3dfbf61463a9b3aeaa4cdc27a1495b.jpg', 'almasxit','2024-06-29 12:48:46', 0, '9', 6, 5),
     ('Greek Mythology', 'I love greek mythology', 'https://images.squarespace-cdn.com/content/v1/5e01d4d4c4faa308239ed7b6/d4c98111-df13-428e-a209-a2bd5b95eae2/ws1ovyxqlq9afvgumsdd.jpg', 'almasxit', '2024-06-29 10:48:46', 1, '8', 11, 4);
...
INSERT INTO test_tags(tag_name, quiz_id)
VALUES
    ('geography','3'),
    ('flags','3'),
    ('gia chanturia','3'),
...
INSERT INTO test_quizzes(quiz_name, description, picture_url, creator_username, created_time, multi_page, category, views, taken)
VALUES
    ('Journey Through History', 'Explore pivotal events and notable figures from history in this engaging seven-question quiz.', 'https://ww1.oswego.edu/history/sites/history/files/styles/16x9_xl/public/2020-12/Historyheaderimage.jpg?h=07e9ee27&itok=gFloL8E9', 'Bacha', '2024-06-29 14:48:46', 1, 2, 19, 3),
    ('European Languages Exploration', 'Discover the diversity of European languages through varied question types, including history, identification, and matching.', 'https://lighthouseonline.com/wp-content/uploads/2023/06/Wooden-signpost-with-languages-1024x683.jpeg' , 'Bacha', '2024-07-06 16:00:51', 0, 3, 20, 0);
...
INSERT INTO test_quiz_history(quiz_id, quiz_name, picture_url, username, score, time_needed, take_date)
VALUES
    ('4','Asoiaf', 'https://awoiaf.westeros.org/images/thumb/f/fc/Cristi_Balanescu_wolves_of_the_north_cover.jpg/900px-Cristi_Balanescu_wolves_of_the_north_cover.jpg', 'almasxit','24.5','82','2024-07-02 10:24:57'),
    ('4','Asoiaf', 'https://awoiaf.westeros.org/images/thumb/f/fc/Cristi_Balanescu_wolves_of_the_north_cover.jpg/900px-Cristi_Balanescu_wolves_of_the_north_cover.jpg', 'user1','20.5','42','2024-07-03 10:24:57'),
    ('4','Asoiaf', 'https://awoiaf.westeros.org/images/thumb/f/fc/Cristi_Balanescu_wolves_of_the_north_cover.jpg/900px-Cristi_Balanescu_wolves_of_the_north_cover.jpg', 'user6','24.5','182','2024-07-01 10:24:57'),
    ('4','Asoiaf', 'https://awoiaf.westeros.org/images/thumb/f/fc/Cristi_Balanescu_wolves_of_the_north_cover.jpg/900px-Cristi_Balanescu_wolves_of_the_north_cover.jpg', 'user2','10','105','2024-07-04 18:44:27'),
    ('1','Mixed Quiz', 'https://viralsolutions.net/wp-content/uploads/2019/06/shutterstock_749036344.jpg', 'almasxit','14','42','2024-07-05 9:24:57'),
    ('1', 'Mixed Quiz', 'https://viralsolutions.net/wp-content/uploads/2019/06/shutterstock_749036344.jpg', 'Bacha', '16', '53', '2024-07-06 18:34:56'),
    ('1', 'Mixed Quiz', 'https://viralsolutions.net/wp-content/uploads/2019/06/shutterstock_749036344.jpg', 'user3', '12', '63', '2024-07-01 20:54:56'),
    ('1', 'Mixed Quiz', 'https://viralsolutions.net/wp-content/uploads/2019/06/shutterstock_749036344.jpg', 'user9', '13', '23', '2024-07-02 12:44:06'),
    ('2', 'Barcelona', 'https://d1ymz67w5raq8g.cloudfront.net/Pictures/480xany/6/5/5/509655_shutterstock_1506580442_769367.jpg', 'Bacha', '7', '12', '2024-07-03 17:55:23'),
    ('2', 'Barcelona', 'https://d1ymz67w5raq8g.cloudfront.net/Pictures/480xany/6/5/5/509655_shutterstock_1506580442_769367.jpg', 'user8', '4', '24', '2024-07-03 14:28:35'),
    ...
    ('2', 'Barcelona', 'https://d1ymz67w5raq8g.cloudfront.net/Pictures/480xany/6/5/5/509655_shutterstock_1506580442_769367.jpg', 'user6', '5', '19', '2024-07-04 23:00:15'),
    ('3', 'Geography!', 'https://study.com/cimages/videopreview/p3c2j8y73a.jpg', 'almasxit', '26.5', '80', '2024-07-05 10:41:17'),
    ('3', 'Geography!', 'https://study.com/cimages/videopreview/p3c2j8y73a.jpg', 'kingslayer', '26.5', '180', '2024-07-05 10:41:17'),
    ('3', 'Geography!', 'https://study.com/cimages/videopreview/p3c2j8y73a.jpg', 'user8', '20.5', '151', '2024-07-02 19:41:17'),
    ('3', 'Geography!', 'https://study.com/cimages/videopreview/p3c2j8y73a.jpg', 'user2', '16', '217', '2024-07-02 21:41:17'),
    ('3', 'Geography!', 'https://study.com/cimages/videopreview/p3c2j8y73a.jpg', 'user7', '7', '104', '2024-07-01 23:51:17'),
    ('5', 'Tarantino', 'https://media.tenor.com/3160R1pQhaEAAAAM/tarantino-sunglasses.gif', 'almasxit', '13.5', '66', '2024-07-02 10:44:08'),
    ('5', 'Tarantino', 'https://media.tenor.com/3160R1pQhaEAAAAM/tarantino-sunglasses.gif', 'user1', '6', '79', '2024-07-02 13:44:08'),
    ('5', 'Tarantino', 'https://media.tenor.com/3160R1pQhaEAAAAM/tarantino-sunglasses.gif', 'user5', '9', '102', '2024-07-04 05:34:08'),
    ...
    ('7', 'Greek Mythology', 'https://images.squarespace-cdn.com/content/v1/5e01d4d4c4faa308239ed7b6/d4c98111-df13-428e-a209-a2bd5b95eae2/ws1ovyxqlq9afvgumsdd.jpg', 'almasxit', '28', '69', '2024-07-06 10:46:41'),
    ('7', 'Greek Mythology', 'https://images.squarespace-cdn.com/content/v1/5e01d4d4c4faa308239ed7b6/d4c98111-df13-428e-a209-a2bd5b95eae2/ws1ovyxqlq9afvgumsdd.jpg', 'user2', '17', '77', '2024-07-01 18:06:38'),
    ...
    ('6', 'Chemistry', 'https://i.pinimg.com/564x/cc/3d/fb/cc3dfbf61463a9b3aeaa4cdc27a1495b.jpg', 'kingslayer', '16.5', '77', '2024-07-01 19:48:46'),
    ('6', 'Chemistry', 'https://i.pinimg.com/564x/cc/3d/fb/cc3dfbf61463a9b3aeaa4cdc27a1495b.jpg', 'user1', '12', '93', '2024-07-04 11:48:46'),
    ('6', 'Chemistry', 'https://i.pinimg.com/564x/cc/3d/fb/cc3dfbf61463a9b3aeaa4cdc27a1495b.jpg', 'user3', '10.5', '83', '2024-07-01 12:48:46'),
    ('6', 'Chemistry', 'https://i.pinimg.com/564x/cc/3d/fb/cc3dfbf61463a9b3aeaa4cdc27a1495b.jpg', 'user6', '13', '103', '2024-07-03 16:48:46'),
    ('6', 'Chemistry', 'https://i.pinimg.com/564x/cc/3d/fb/cc3dfbf61463a9b3aeaa4cdc27a1495b.jpg', 'user2', '5', '44', '2024-07-02 01:48:46'),
    ('8', 'Journey Through History', 'https://ww1.oswego.edu/history/sites/history/files/styles/16x9_xl/public/2020-12/Historyheaderimage.jpg?h=07e9ee27&itok=gFloL8E9', 'Bacha', '7', '54', '2024-07-02 01:48:46'),
    ('8', 'Journey Through History', 'https://ww1.oswego.edu/history/sites/history/files/styles/16x9_xl/public/2020-12/Historyheaderimage.jpg?h=07e9ee27&itok=gFloL8E9', 'user4', '3', '44', '2024-07-03 01:48:46'),
    ('8', 'Journey Through History', 'https://ww1.oswego.edu/history/sites/history/files/styles/16x9_xl/public/2020-12/Historyheaderimage.jpg?h=07e9ee27&itok=gFloL8E9', 'user8', '4', '44', '2024-07-04 01:48:46');
