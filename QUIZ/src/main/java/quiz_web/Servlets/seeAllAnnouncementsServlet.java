...
@WebServlet("/seeAnnouncements")
public class seeAllAnnouncementsServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws ServletException, IOException {
        ...
        try {
            ...
            httpServletRequest.getRequestDispatcher("/homePage/allAnnouncements.jsp").forward(httpServletRequest, httpServletResponse);
