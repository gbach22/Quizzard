...
<html>
    ...
    <body>
        ...
        <div class="inner_body">
            <img class="pic" src="<%=curQuestion.getPictureUrl()%>" alt="Picture Response">
            <br>
            <input type="input" placeholder="Type in your answer here" name="question<%=queue%>answer" <%=disabledStr%>>
